...
<form name="IHForm" method="Post">
   <br>
    <TABLE width="60%" border="0" align=center cellPadding=0 cellSpacing=0  class="table_bg">
        <TR>
        ...
        <TR>
          <TD colspan="2">
	          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_edit">
	            <tr>
	              <td width="24%" align='right' class="tablecontent1"><fmt:message key="ImportHospital.Name"/></td>
	              <td width=1%  align=center><strong>:</strong></td>
	              <td width="25%" class="tablecontent1">
	              <c:out value="${command.hospital.hospitalName}"/>
	              <br></td>
	            </tr>
	            <tr>
	              ...
	              <td class="tablecontent1">
	    		   ...
	    		   </spring:bind>&nbsp;<fmt:message key="Ipaddress.hospitaltype"/><br>
	              </td>
	            </tr>
				<tr>
