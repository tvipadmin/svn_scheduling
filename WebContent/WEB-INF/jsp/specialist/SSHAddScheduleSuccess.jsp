...
<tr>
<td class="center"><br><input name="sumbit" type="button" OnClick="javascript:document.location.href='SSHAddSchedule.htm?day=<c:out value="${sBO.day}"/>';" class="button" value=" <fmt:message key="button.Ok"/> "/>
</td>
</tr>
</table>
</form>
