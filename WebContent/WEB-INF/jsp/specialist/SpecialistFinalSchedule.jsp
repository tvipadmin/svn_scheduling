...
{
	document.forms[0].action="SpecialistFinalSchedule.htm";
...
<div id="Card" style="display:none">
	<jsp:include page="/WEB-INF/jsp/specialist/SpecialistFinalSchedulePrintList.jsp"/>
</div>
<div id="AddedMessage">
...
<c:if test="${sBO.searchFilters}">
  ...
  <TR>
   ...
   &nbsp;&nbsp;
     <input tabindex="20" name="selectbutton" type='button' OnClick="javascript:submitSearchPage();" class='button' value='Search'> &nbsp;&nbsp; &nbsp;&nbsp;<input name="sumbit" type="button" OnClick="javascript:document.location.href='Specialist.htm';" class="button" value=" <fmt:message key="button.Back"/> "/></td>
...
<br>
	<center> <input type="submit" class="button" name="chk_Print" value="Print"> </td> </center>
