...
<TABLE width="98%" border="0" align=center cellPadding=0 cellSpacing=0 class="table_bg">
  ...
  <TR>
    <TD colspan="3"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_list">
      <tr class="left"><th width="5%"><fmt:message key="schedule.Row.No"/></th><th width="17%"><fmt:message key="schedule.SSH.Hospital"/></th><th width="17%" align="CENTER"><fmt:message key="schedule.Specialty"/></th><th align="CENTER" width="10%"><fmt:message key="schedule.Day"/></th><th align="CENTER" width="17%"><fmt:message key="schedule.FromTime"/></th><th align="CENTER" width="17%"><fmt:message key="schedule.ToTime"/></th></tr>
      <c:set var="scheduleCount" value="0" scope="page"/>
			...
			<c:forEach var="schedule" items="${sBO.finalScheduleList}">
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_edit">													
			        ...
			        <spring:bind path="sBO.finalScheduleList[${I.index}].sshHospital.hospitalId">
			      ...
			      <td align="CENTER" width="10%">
			        <spring:bind path="sBO.finalScheduleList[${I.index}].day">
...
<TABLE width="98%" border="0" align=center cellPadding=0 cellSpacing=0 class="table_bg">
 ...
 <TR>
    <TD width="60%" class="right bold"><c:out value="${sBO.day}"/></TD>
 </TR>
    </TABLE>
    <br>
