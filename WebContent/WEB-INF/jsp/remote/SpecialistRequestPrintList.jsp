...
<c:choose>
          <c:when test="${command.checkday=='selected'}">
            <center><h3><b><c:out value="${command.peschedule.day}"/>&nbsp;<fmt:message key="print.schedule.Request"/> &nbsp;<fmt:message key="schedule.heading.Schedule"/></b></h3></center>
          </c:when>
            <c:otherwise>
        	<center><h3><b> <fmt:message key="print.schedule.Request"/>&nbsp;<fmt:message key="schedule.heading.Schedule"/></TD></b></h3></center>
          </c:otherwise>
        </c:choose>
