...
<br>
<div align="right"><jsp:include page="/WEB-INF/jsp/menu/ViewSSHAvailability.jsp"></jsp:include></div>
<br>
...
<TABLE width="98%" border="0" align=center cellPadding=0 cellSpacing=0 class="table_bg">
  ...
  <TR>
    <TD colspan="3"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_list">
      <tr class="left"><th width="17%"><fmt:message key="schedule.SSH.Hospital"/></th><th width="17%" align="CENTER"><fmt:message key="schedule.Specialty"/></th><th align="CENTER" width="10%"><fmt:message key="schedule.Day"/></th><th align="CENTER" width="17%"><fmt:message key="schedule.FromTime"/></th><th align="CENTER" width="17%"><fmt:message key="schedule.ToTime"/></th></tr>
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_edit">													
			        ...
			        <spring:bind path="sBO.peSchedule.sshHospital.hospitalId">
			        ...
			        <td align="CENTER" width="17%"><spring:bind path="sBO.peSchedule.specialty">
			        ...
			        <spring:bind path="sBO.peSchedule.day">
			        ...
			        <spring:bind path="sBO.peSchedule.fromHour">
			        ...
			        <spring:bind path="sBO.peSchedule.fromMin">
					...
					<c:if test="${sBO.minArray != null}">
			         ...
			         <td align="CENTER" width="17%">
			        <spring:bind path="sBO.peSchedule.toHour">
			        ...
			        <spring:bind path="sBO.peSchedule.toMin">
...
<TR>
	<TD width=50% class="center">
		<input name="sumbit" type="button" OnClick="javascript:document.location.href='Patient.htm?';" class="button" value=" <fmt:message key="button.Back"/> "/>&nbsp;&nbsp;
