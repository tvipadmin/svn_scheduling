...
<tr>
<td class="center"><br><input name="sumbit" type="button" OnClick="javascript:document.location.href='AddSchedule.htm';" class="button" value=" <fmt:message key="button.Ok"/> "/>
</td>
</tr>
</table>
